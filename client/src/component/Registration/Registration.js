                ...
                <form>
                  ...
                  <div className="div-li">
                    <label className={"label-r"}>
                      ...
                      <input
                        className={"input-r"}
                        type="text" value={this.state.voterName}
                  ...
                  <button
                    className="btn-add"
                    // disabled={
                    //   this.state.voterPhone.length !== 20 ||
                    //   this.state.currentVoter.isVerified
                    // }

                    disabled={
                      this.state.currentVoter.isVerified || // Check if email is verified
                      !this.state.voterPhone.endsWith('@vitstudent.ac.in') // Check if email ends with specified domain
                  }
